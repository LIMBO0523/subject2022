...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li> <a href="student_list.jsp" class="waves-effect"><i  class="mdi mdi-creation fa-fw"></i> <span class="hide-menu">管理学生</span></a> </li>
            ...
            <li> <a href="paper_list_student.jsp" class="waves-effect"><i class="mdi mdi-account-edit fa-fw"></i> <span class="hide-menu">管理文献</span></a> </li>

            <li> <a href="experiment_list_student.jsp" class="waves-effect"><i class="mdi mdi-update fa-fw"></i> <span class="hide-menu">管理实验</span></a> </li>

            <li class="devider"></li>

            <li> <a href="receive_list_teacher.jsp" class="waves-effect"><i class="mdi mdi-key-variant fa-fw"></i> <span class="hide-menu">已收信息</span></a> </li>

            <li> <a href="send_list_teacher.jsp" class="waves-effect"><i class="mdi mdi-key-variant fa-fw"></i> <span class="hide-menu">已发信息</span></a> </li>
            <li class="devider"></li>
