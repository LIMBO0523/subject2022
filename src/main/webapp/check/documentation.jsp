                ...
                <div class="col-md-12">
                    <div class="white-box">
                        ...
                        <ul class="list-inline list-social-icons mb-0">
                            ...
                            <li class="list-inline-item">
                                <a href="http://wpa.qq.com/msgrd?v=3&uin=452128995&site=qq&menu=yes">
                                  <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <li class="list-inline-item">
                                <a href="https://chwangteng.cn/cleanblog/wechatqrcode.jsp">
                                  <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                            ...
                            <li class="list-inline-item">
                                <a href="https://github.com/chwangteng">
                                  <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
