        ...
        <div class="top-left-part">
            ...
            <a class="logo" href="/mes/index.jsp">
                ...
                <!-- Logo text image you can use text also --><span class="hidden-xs">
                        <!--This is dark logo text--><img src="../plugins/images/admin-dark.png" alt="home" class="dark-logo" /><!--This is light logo text--><img src="../plugins/images/admin-light.png" alt="home" class="light-logo" />
                     </span> </a>
        </div>
        <!-- /Logo -->
